...
console.log('  2. API transformation might be overriding the __raw_backend_response');
...
console.log('  3. Verify ChartDisplay is using fetchChartData vs fetchSavedChart');
