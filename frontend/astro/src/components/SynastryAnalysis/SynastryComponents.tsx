...
export const CompatibilityScore: React.FC<CompatibilityScoreProps> = React.memo(({ 
  ...
  <div className="col-span-1 lg:col-span-2 cosmic-card border border-cosmic-silver/30">
    <div className="p-4">
...
export const KeyAspects: React.FC<KeyAspectsProps> = React.memo(({ 
  ...
  <div className="cosmic-card border border-cosmic-silver/30 h-fit">
    <div className="p-4">
...
export const HouseOverlays: React.FC<HouseOverlaysProps> = React.memo(({ 
  ...
  <div className="cosmic-card border border-cosmic-silver/30">
    <div className="p-4">
