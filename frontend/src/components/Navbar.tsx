        ...
        <Flex alignItems="center">
          {user ? (
            <>
              ...
              <Button colorScheme="yellow" variant="ghost" mr={2} onClick={() => navigate('/saved-charts')}>
                Saved Charts
              </Button>
              <Menu>
                ...
                <MenuList bg={bg}>
                  ...
                  <MenuItem onClick={() => navigate('/premium')}>Go Premium</MenuItem>
                </MenuList>
              </Menu>
              <Button colorScheme="red" variant="outline" borderColor="gold" color={color} onClick={handleLogout}>
                Log Out
              </Button>
            </>
          ) : (
            <>
              ...
              <Button colorScheme="yellow" variant="ghost" onClick={() => navigate('/signup')}>
                Signup
              </Button>
            </>
          )}
