      ...
      <div className="container px-6 mx-auto">
        <div className="text-center">
          ...
          <div className="flex justify-center mb-6 space-x-8 text-sm text-gray-400">
            <a href="/privacy" className="transition-colors duration-200 hover:text-cyan-400">
              Privacy Policy
            </a>
            <a href="/terms" className="transition-colors duration-200 hover:text-cyan-400">
              Terms of Service
            </a>
            <a href="/contact" className="transition-colors duration-200 hover:text-cyan-400">
              Contact Us
            </a>
            <a href="/science" className="transition-colors duration-200 hover:text-cyan-400">
              The Science
            </a>
          </div>
