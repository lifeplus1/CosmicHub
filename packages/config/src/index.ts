...
export { ok, fail, toFailure, isSuccess, isFailure, unwrap, unwrapOr, mapResult, mapSuccess, mapFailure, ErrorCode } from './utils/api/result';
export type { ApiResult, ApiSuccess, ApiFailure, ErrorCodeValue } from './utils/api/result';
// Logger abstraction
...
export { mockHttpError, failureFromStatus, rawFailure } from './utils/api/test-helpers';
export { mockAuthFailure, mockNotFoundFailure, mockValidationFailure, isAuthFailure, isNotFoundFailure, isValidationFailure } from './utils/api/network-mocks';
