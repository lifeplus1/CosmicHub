...
export interface SmartPreloadFunctions {
    ...
    preloadOnHover: <T extends ComponentType<any>>(elementRef: React.RefObject<HTMLElement>, componentImport: ImportFunction<T>, componentName: string) => (() => void) | undefined;
    /** Preload a component when an element becomes visible */
    preloadOnIntersection: <T extends ComponentType<any>>(elementRef: React.RefObject<HTMLElement>, componentImport: ImportFunction<T>, componentName: string) => (() => void) | undefined;
}
/**
 ...
 */
export type LazyComponentCreator = <T extends ComponentType<any>>(importFn: ImportFunction<T>, componentName: string, options?: LazyComponentOptions) => ComponentType<ComponentProps<T>>;
/**
 * Creates a type-safe lazy route
 */
export type LazyRouteCreator = <T extends ComponentType<any>>(importFn: ImportFunction<T>, routeName: string) => ComponentType<ComponentProps<T>>;
/**
 * Creates a type-safe lazy modal
 */
export type LazyModalCreator = <T extends ComponentType<any>>(importFn: ImportFunction<T>, modalName: string) => ComponentType<ComponentProps<T>>;
/**
 * Creates a type-safe lazy chart
 */
export type LazyChartCreator = <T extends ComponentType<any>>(importFn: ImportFunction<T>, chartName: string) => ComponentType<ComponentProps<T>>;
/**
 * Higher-order component for lazy loading
 */
export type WithLazyLoading = <P extends object>(importFn: ImportFunction<ComponentType<P>>, componentName: string, options?: Pick<LazyComponentOptions, 'loadingComponent' | 'preload'>) => ComponentType<P>;
/**
 * Hook for progressive loading
 */
export type UseProgressiveLoading = <T>(items: T[], options: ProgressiveLoadingOptions) => ProgressiveLoadingResult<T>;
/**
