...
describe('Report Generation', () => {
  it('emits report:generated events and writes files', async () => {
    ...
    const jsonEvent = reports.find(r => r.format === 'json') as
      | ReportGeneratedEvent
      | undefined;
    const htmlEvent = reports.find(r => r.format === 'html') as
      | ReportGeneratedEvent
      | undefined;

    if (
      jsonEvent !== undefined &&
      jsonEvent.location !== undefined &&
      jsonEvent.location !== null
    ) {
    ...
    if (
      htmlEvent !== undefined &&
      htmlEvent.location !== undefined &&
      htmlEvent.location !== null
    ) {
