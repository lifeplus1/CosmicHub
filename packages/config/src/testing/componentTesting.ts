...
export interface ComponentTestConfig {
  name: string;
  component: React.ComponentType<Record<string, unknown>>; // accept flexible props for test components
...
// Accept strongly typed component; loosen parameter using unknown with proper type constraint for flexible test components
