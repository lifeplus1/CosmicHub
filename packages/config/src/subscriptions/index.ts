...
export interface BasicTierPrice {
  monthly: number;
  yearly: number;
}
...
export const HEALWAVE_TIERS: Record<string, HealwaveSubscriptionTier> = {
  free: {
    ...
    limits: { sessionsPerDay: 2, sessionMaxDuration: 20 * 60 },
...
export const FEATURE_TOOLTIPS: Record<
  string,
  {
    title: string;
    description: string;
...
> = {
  basicCharts: {
    ...
    description:
      'Calculate accurate natal charts using Western tropical astrology with essential planetary positions and aspects.',
    examples: [
  ...
  multiSystemAnalysis: {
    ...
    description:
      'Compare insights from multiple astrological traditions including Western, Vedic, Chinese, and Mayan systems.',
    examples: [
  ...
  synastryAnalysis: {
    ...
    description:
      'Analyze relationship dynamics by comparing two birth charts to understand compatibility and potential challenges.',
    examples: [
  ...
  transitAnalysis: {
    ...
    description:
      'Track current planetary movements and their effects on your natal chart for timing and predictive insights.',
    examples: [
  ...
  aiInterpretation: {
    ...
    description:
      'Advanced artificial intelligence analyzes complex chart patterns to provide personalized, nuanced interpretations.',
    examples: [
  ...
  pdfExport: {
    title: 'PDF Export',
    description:
      'Generate professional-quality chart reports and interpretations that you can save, print, or share.',
    examples: [
...
export const hasFeatureAccess = (
  userTier: string,
  requiredTier: string,
  tiers: Record<string, HealwaveSubscriptionTier | AstroSubscriptionTier>
) => {
...
export const getTierLimits = (
  tier: string,
  limit: keyof AstroSubscriptionTier['limits']
) => {
