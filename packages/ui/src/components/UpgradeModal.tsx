...
export const UpgradeModal: React.FC<UpgradeModalProps> = ({
  ...
  const getRecommendedTier = (): 'Basic' | 'Pro' | 'Enterprise' => {
    if (
      feature?.includes('Gene Keys') ||
      feature?.includes('Synastry') ||
              ...
              return (
                ...
                >
                  ...
                  <div className='text-center mb-6'>
                    <TierIcon
                      className={`w-12 h-12 mx-auto mb-4 text-cosmic-${tier.color}`}
                    />
                  ...
                  <Button
                    onClick={() =>
                      onUpgrade(tierKey as 'Basic' | 'Pro' | 'Enterprise')
                    }
          ...
          <div className='mt-8 bg-gray-50 rounded-xl p-6'>
            ...
            <div className='grid md:grid-cols-2 gap-4'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  <h4 className='font-semibold text-cosmic-dark mb-1'>
                    Advanced Insights
                  </h4>
                  <p className='text-gray-600 text-sm'>
                    Unlock deeper astrological analysis and personalized
                    insights
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 text-sm'>
                    Access Gene Keys, frequency therapy, and compatibility
                    analysis
                  </p>
                </div>
              </div>
