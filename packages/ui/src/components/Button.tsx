...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = "px-4 py-2 rounded-md font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-cosmic-purple/50";
  
  const variantClasses = {
    primary: "bg-cosmic-purple hover:bg-cosmic-purple/80 text-cosmic-gold shadow-lg shadow-cosmic-purple/20 cosmic-glow",
