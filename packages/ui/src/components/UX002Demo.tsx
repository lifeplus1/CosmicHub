...
export const UX002Demo: React.FC = () => {
  ...
  const cards = [
    ...
    { id: 2, title: 'Animation Card 2', content: 'Delightful micro-interactions' },
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="text-2xl">
            Total Interactions: <CountUp value={counter} duration={2000} prefix="+" />
          </div>
        </div>

        {/* Stagger Animation Demo */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-cosmic-gold">Stagger Animations</h2>
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <h2 className="text-2xl font-semibold text-cosmic-gold">Interactive Elements</h2>
            ...
            <div className="space-y-4">
              ...
              <InteractiveRating
                ...
                icon="star"
              />
              <p className="text-sm text-cosmic-silver/70">Current: {rating}/5</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <RippleButton variant="primary" onClick={() => setCounter(prev => prev + 1)}>
                  Primary
                </RippleButton>
                <RippleButton variant="secondary" onClick={() => setCounter(prev => prev + 1)}>
                  Secondary
                </RippleButton>
                <RippleButton variant="ghost" onClick={() => setCounter(prev => prev + 1)}>
                  Ghost
                </RippleButton>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-semibold text-cosmic-gold">Progress & Feedback</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <AnimatedTooltip content="Top tooltip with delay" position="top">
                  <button
                    type="button"
                ...
                <AnimatedTooltip content="Bottom tooltip" position="bottom" delay={200}>
                  <button
                    type="button"
                    className="px-4 py-2 bg-cosmic-silver/20 rounded hover:bg-cosmic-silver/30"
                  >
        ...
        <section className="bg-cosmic-purple/10 border border-cosmic-purple/30 rounded-lg p-6">
          ...
          <p className="text-cosmic-silver/80">
            All animations are hardware-accelerated and use Intersection Observer for optimal performance.
            They respect user preferences for reduced motion and are fully accessible.
          </p>
        </section>
