 ...
 */
export declare function useStateValidation(options?: UseStateValidationOptions): {
    validateData: <T>(data: T, rules: ValidationRule<T>[], fieldName?: string) => Promise<ValidationResult>;
    validateBirthData: (data: BirthData) => Promise<ValidationResult>;
    validateChartData: (data: ChartData) => Promise<ValidationResult>;
    validateField: <T>(fieldName: string, value: T, fieldRules: ValidationRule<T>[]) => Promise<ValidationResult>;
