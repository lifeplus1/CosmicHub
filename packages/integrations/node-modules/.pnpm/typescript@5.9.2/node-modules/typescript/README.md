...
and stay up to date via [our blog](https://blogs.msdn.microsoft.com/typescript) and
...
[contribute](https://github.com/microsoft/TypeScript/blob/main/CONTRIBUTING.md) to TypeScript.
