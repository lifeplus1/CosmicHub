...
[Please refer to the full commit logs available on GitHub](https://github.com/chaijs/chai/commits).
...
- Rewrite pretty-printing HTML elements to prevent throwing internal errors Fixes errors occuring
  when using a non-native DOM implementation
...
- Adding members and memberEquals assertions for checking for subsets and set equality. Implements
  chaijs/chai#148.
...
- version bumb 0.6.0
- browser build
- [refactor] browser compile function to replace with `require('./error')' with
