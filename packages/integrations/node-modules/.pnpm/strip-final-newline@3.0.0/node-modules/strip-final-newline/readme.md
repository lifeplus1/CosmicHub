...
Can be useful when parsing the output of, for example, `ChildProcess#execFile`, as
...
Normally, you would use `stdout.trim()`, but that would also remove newlines at the start and
whitespace.
