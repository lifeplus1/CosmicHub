...
This is a module to retrieve a function's name securely and consistently both in NodeJS and the
browser.
...
You can also use it within the browser; install via npm and use the `get-func-name.js` file found
