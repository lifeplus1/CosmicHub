...
Strip comments and string literals from JavaScript code. Powered by
...
Comments, string literals will be replaced by spaces with the same length to keep the source map
untouched.
