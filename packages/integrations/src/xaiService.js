...
export class XAIService {
    ...
    static getApiKey() {
        ...
        if (typeof import.meta !== 'undefined' && import.meta.env?.VITE_XAI_API_KEY) {
            return import.meta.env.VITE_XAI_API_KEY;
        }
        throw new Error('XAI_API_KEY environment variable is not set');
    }
    static async generateInterpretation(request) {
        // Validate request
        try {
...
Help them understand their relationship dynamics and attract healthy partnerships.`
    ...
    static async generateMockInterpretation(request) {
        // Simulate API delay
