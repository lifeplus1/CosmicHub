...
describe('XAIService', () => {
  ...
  describe('generateInterpretation', () => {
    ...
    it('throws error when API key is missing', async () => {
      ...
      await expect(XAIService.generateInterpretation(mockRequest)).rejects.toThrow(
    ...
    it('validates request data', async () => {
      ...
      await expect(XAIService.generateInterpretation(invalidRequest)).rejects.toThrow(
