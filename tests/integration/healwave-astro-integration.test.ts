...
describe('Component Integration', () => {
  it('should import and instantiate ChartPreferences components from both apps', async () => {
    ...
    const astroModule = await import(
      '../../apps/astro/src/components/ChartPreferences'
    );
    const healwaveModule = await import(
      '../../apps/healwave/src/components/ChartPreferences'
    );
  ...
  it('should render basic test components without errors', () => {
    ...
    expect(screen.getByTestId('integration-test')).toHaveTextContent(
      'Integration test component'
    );
  });
  ...
  it('should handle component integration scenarios', () => {
    ...
    const mockIntegrationComponent = React.createElement(
      'div',
      {
      ...
      [
        ...
        React.createElement(
          'p',
          { key: 'description' },
          'This simulates component integration between apps'
        ),
        React.createElement(
          'button',
          {
