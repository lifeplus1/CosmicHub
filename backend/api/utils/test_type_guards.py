...
class TestTypeGuards(unittest.TestCase):
    ...
    def test_get_astrology_data_type(self):
        ...
        self.assertEqual(get_astrology_data_type(self.valid_chart), "AstrologyChart")
        self.assertEqual(get_astrology_data_type(self.valid_profile), "UserProfile")
        self.assertEqual(get_astrology_data_type(self.valid_numerology), "NumerologyData")
