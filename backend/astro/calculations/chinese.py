...
ANIMAL_TRAITS: Dict[str, Dict[str, Any]] = {
    "Rat": {
        ...
        "lucky_numbers": [2, 3],
        "element_years": "Yang Water",
    },
    "Ox": {
        "traits": "Reliable, patient, honest",
        "lucky_numbers": [1, 9],
        "element_years": "Yin Earth",
    },
    "Tiger": {
        "traits": "Brave, confident, competitive",
        "lucky_numbers": [1, 3, 4],
        "element_years": "Yang Wood",
    },
    "Rabbit": {
        "traits": "Gentle, quiet, elegant",
        "lucky_numbers": [3, 4, 6],
        "element_years": "Yin Wood",
    },
    "Dragon": {
        "traits": "Confident, intelligent, enthusiastic",
        "lucky_numbers": [1, 6, 7],
        "element_years": "Yang Earth",
    },
    "Snake": {
        "traits": "Wise, charming, intuitive",
        "lucky_numbers": [2, 8, 9],
        "element_years": "Yin Fire",
    },
    "Horse": {
        "traits": "Energetic, independent, cheerful",
        "lucky_numbers": [2, 3, 7],
        "element_years": "Yang Fire",
    },
    "Goat": {
    ...
    "Monkey": {
        ...
        "lucky_numbers": [1, 7, 8],
        "element_years": "Yang Metal",
    },
    "Rooster": {
        "traits": "Observant, hardworking, courageous",
        "lucky_numbers": [5, 7, 8],
        "element_years": "Yin Metal",
    },
    "Dog": {
...
def calculate_chinese_elements_compatibility(
    ...
    if animal2 in highly_compatible.get(animal1, []):
        return {
            "compatibility": "High",
            "description": "Excellent match with natural harmony",
        }
    elif animal2 in incompatible.get(animal1, []):
        return {
            "compatibility": "Low",
            "description": "Challenging combination requiring effort",
        }
    else:
        return {
            "compatibility": "Moderate",
            "description": "Good potential with understanding",
        }


def get_chinese_five_elements_analysis(
    year_element: str, birth_hour: int
) -> Dict[str, Any]:
...
def calculate_chinese_astrology(
    ...
    try:
        ...
        elements_analysis = get_chinese_five_elements_analysis(
            year_element, hour
        )
        ...
        for animal in ["Rat", "Dragon", "Tiger"]:
            if animal != year_animal:
                compatibility_examples[animal] = (
                    calculate_chinese_elements_compatibility(
                        year_animal, animal
                    )
                )
