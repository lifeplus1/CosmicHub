...
class TestValidateInputs:
    ...
    def test_valid_inputs(self):
        ...
        assert (
            validate_inputs(
                1990, 5, 15, 14, 30, 40.7128, -74.0060, city="New York"
            )
            is True
        )
    ...
    def test_invalid_year_too_early(self):
        ...
        with pytest.raises(
            ValueError, match="Year 1899 must be between 1900 and 2100"
        ):
    ...
    def test_invalid_year_too_late(self):
        ...
        with pytest.raises(
            ValueError, match="Year 2101 must be between 1900 and 2100"
        ):
    ...
    def test_invalid_month(self):
        ...
        with pytest.raises(
            ValueError, match="Month 13 must be between 1 and 12"
        ):
            validate_inputs(1990, 13, 15, 14, 30)

        with pytest.raises(
            ValueError, match="Month 0 must be between 1 and 12"
        ):
    ...
    def test_invalid_day(self):
        ...
        with pytest.raises(
            ValueError, match="Day 32 must be between 1 and 31"
        ):
    ...
    def test_invalid_hour(self):
        ...
        with pytest.raises(
            ValueError, match="Hour 24 must be between 0 and 23"
        ):
            validate_inputs(1990, 5, 15, 24, 30)

        with pytest.raises(
            ValueError, match="Hour -1 must be between 0 and 23"
        ):
    ...
    def test_invalid_minute(self):
        ...
        with pytest.raises(
            ValueError, match="Minute 60 must be between 0 and 59"
        ):
            validate_inputs(1990, 5, 15, 14, 60)

        with pytest.raises(
            ValueError, match="Minute -1 must be between 0 and 59"
        ):
    ...
    def test_invalid_latitude(self):
        ...
        with pytest.raises(
            ValueError, match="Latitude 91 must be between -90 and 90"
        ):
    ...
    def test_invalid_longitude(self):
        ...
        with pytest.raises(
            ValueError, match="Longitude 181 must be between -180 and 180"
        ):
...
class TestCalculateChart:
    ...
    def test_chart_calculation_with_city(self):
        ...
        result = calculate_chart(
            year=1990, month=5, day=15, hour=14, minute=30, city="New York"
        )
