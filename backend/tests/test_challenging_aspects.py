...
def test_analyze_challenging_aspects_classification_and_sort():
    aspects: List[Dict[str, Any]] = [
        ...
        },  # mild (orb >4)
        {
            ...
            "point1": "Venus",
            "point2": "Jupiter",
        },  # supportive, should be filtered out
        {
            "aspect": "Quincunx",
            "orb": 2.4,
            "point1": "Sun",
    ...
    severities = {
        (c.get("aspect") or c.get("type")): c["severity"] for c in classified
    }
    ...
    assert severities["Square"] in {
        "high",
        "moderate",
    }  # two squares: one high (0.8) one moderate (3.9)
