...
from astro.calculations.personality import get_personality_traits, get_sun_sign
...
class TestPersonalityTraits:
    ...
    def test_get_personality_traits_aries(self):
        ...
        chart = {"planets": {"sun": {"position": 15.0}}}  # 15 degrees = Aries
    ...
    def test_get_personality_traits_invalid_chart(self):
        ...
        invalid_chart = {"planets": {"sun": {}}}  # Missing position
    ...
    def test_get_personality_traits_missing_sun(self):
        ...
        invalid_chart = {"planets": {}}  # Missing sun
...
class TestSunSignCalculation:
    ...
    def test_get_sun_sign_negative_degrees(self):
        ...
        assert (
            get_sun_sign(-30.0) == "Pisces"
        )  # -30 % 360 = 330 (11th sign - Pisces)
