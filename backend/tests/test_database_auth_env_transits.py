...
def test_transits_helper_functions(monkeypatch: pytest.MonkeyPatch):
    ...
    assert phase["phase"] in ("new_moon","waxing_crescent","first_quarter","waxing_gibbous","full_moon","waning_gibbous","last_quarter","waning_crescent")
...
def test_transits_endpoints_small_range(monkeypatch: pytest.MonkeyPatch):
    ...
    payload: dict[str, object] = {
        "birth_data": {"birth_date":"1990-01-01","birth_time":"00:00:00","latitude":0.0,"longitude":0.0,"timezone":"UTC"},
