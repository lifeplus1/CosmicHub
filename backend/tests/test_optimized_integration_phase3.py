...
class TestOptimizedVectorizedAspectCalculator:
    ...
    def test_fallback_calculation(self):
        ...
        with patch('utils.optimized_vectorized_integration.VectorizedAspectCalculator', 
...
class TestPerformanceComparison:
    ...
    def test_basic_performance_comparison(self):
        ...
        from utils.optimized_vectorized_integration import migrate_traditional_to_optimized
...
class TestErrorHandling:
    ...
    def test_empty_charts_handling(self):
        ...
        try:
            result = calculator.calculate_synastry_aspects(empty_chart, normal_chart)
    ...
    def test_invalid_orb_values(self):
        ...
        # Negative orb
        result = calculator.calculate_synastry_aspects(chart1, chart2, orb=-5.0)
        assert isinstance(result, np.ndarray)
        
        # Very large orb
        result = calculator.calculate_synastry_aspects(chart1, chart2, orb=180.0)
        assert isinstance(result, np.ndarray)
