"""
TCM Mock Data - Tier 3: Testing and Mock Data Generation
Optimized for testing, development, and data validation
"""

from typing import Dict, Any, Optional
import random
from datetime import datetime, timedelta
from backend.types.tcm_analytics_schema import TCMAnalyticsRecord
from backend.types.tcm_api_types import (
    TCMAnalysisResponse, 
...
class TCMMockDataGenerator:
    ...
    def generate_mock_analytics_record(
        ...
        primary_element = max(element_balance.items(), key=lambda x: x[1])[0]
