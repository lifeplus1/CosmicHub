  ...
  return (
    <div className='enhanced-aspect-table'>
          ...
          <TableBody>
            {sortedAspects.map((aspect, index) => {
              ...
              return (
                <TableRow
                  key={index}
                  className={`${aspectColor} hover:bg-cosmic-dark/10`}
                >
                      ...
                      <div
                        className={`w-3 h-3 rounded-full ${
                          aspect.strength === 'exact'
                            ? 'bg-cosmic-red shadow-cosmic-red/50 shadow-lg'
                            : aspect.strength === 'strong'
                              ? 'bg-cosmic-gold shadow-cosmic-gold/50 shadow-lg'
                              : aspect.strength === 'moderate'
                                ? 'bg-cosmic-purple shadow-cosmic-purple/50 shadow-lg'
                                : 'bg-cosmic-silver/50'
                        }`}
                      />
      ...
      <div className='mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
        ...
        <div className='bg-cosmic-purple/10 border border-cosmic-purple/20 p-3 rounded-lg'>
          ...
          <div className='text-2xl font-bold text-cosmic-purple'>
            {
              sortedAspects.filter(a => ASPECT_DEFINITIONS[a.aspectType].isHard)
                .length
            }
          </div>
        </div>
        ...
        <div className='bg-cosmic-gold/10 border border-cosmic-gold/20 p-3 rounded-lg'>
          ...
          <div className='text-2xl font-bold text-cosmic-gold'>
            {
              sortedAspects.filter(
                a => !ASPECT_DEFINITIONS[a.aspectType].isHard
              ).length
            }
          </div>
        </div>
      ...
      <div className='mt-4 cosmic-glass border border-cosmic-purple/30 rounded-lg p-4'>
        <div className='font-semibold text-cosmic-gold mb-2'>
