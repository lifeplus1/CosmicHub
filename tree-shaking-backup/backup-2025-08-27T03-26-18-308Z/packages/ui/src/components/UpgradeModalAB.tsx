...
export function UpgradeModalAB({
    ...
    switch (headlineTest.variant) {
      ...
      case 'benefit':
        return {
          ...
          subtitle:
            'Get deeper insights with premium astrology and healing features',
        };
      default:
        return {
    ...
    <div className='ab-test-wrapper' data-testid='upgrade-modal-ab'>
      ...
      {props.isOpen && (
        ...
        >
          ...
          <div
            className='custom-headline-overlay pointer-events-auto'
            data-testid='custom-headline'
          >
          ...
          {headlineTest.variant === 'urgency' && (
            <div
              className='social-proof-banner absolute top-16 left-4 right-4 pointer-events-auto'
              data-testid='social-proof'
            >
              <div className='bg-red-500 text-white px-3 py-2 rounded-lg text-center text-sm'>
                🔥 <strong>500+ users upgraded this week!</strong> Limited time
                offer
              </div>
            </div>
          )}
          ...
          {headlineTest.variant === 'benefit' && (
            <div
              className='benefit-highlights absolute bottom-20 left-4 right-4 pointer-events-auto'
              data-testid='benefit-highlights'
            >
          ...
          {headlineTest.variant === 'standard' && (
            <div
              className='trust-badges absolute bottom-4 left-4 right-4 pointer-events-none'
          ...
          {buttonTest.variant === 'start_trial' && (
            <div
              className='trial-info absolute top-24 left-4 right-4 pointer-events-auto'
              data-testid='trial-info'
            >
              <div className='bg-green-100 border-l-4 border-green-500 p-3 rounded'>
                <p className='trial-text text-green-800 text-sm'>
                  🎁 Start your <strong>7-day free trial</strong> - no
                  commitment required!
                </p>
                <p className='trial-subtext text-green-600 text-xs mt-1'>
          ...
          {pricingTest.variant === 'annual_discount' && (
            <div
              className='savings-highlight absolute bottom-12 left-4 right-4 pointer-events-auto'
