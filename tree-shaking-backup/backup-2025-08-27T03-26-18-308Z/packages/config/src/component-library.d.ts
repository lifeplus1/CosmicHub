...
export declare function withPerformanceTracking<
  P extends Record<string, unknown>,
>(Wrapped: ComponentType<P>, name: string): FC<P>;
...
export declare function createCompoundComponent<
...
export declare function createPolymorphicComponent<
...
export declare class ComponentPerformanceAnalyzer {
  ...
  getComponentAnalysis(component: string): Record<
    string,
    {
      count: number;
      average: number;
...
export declare function withMemoization<P extends Record<string, unknown>>(
