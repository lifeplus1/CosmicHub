  ...
  return (
    <FeatureGuard feature='transitAnalysis' requiredTier='premium'>
      <div className='max-w-6xl p-6 mx-auto'>
        <div className='mb-8'>
          <h1 className='mb-4 text-3xl font-bold text-cosmic-gold'>
            Transit Analysis
          </h1>
          <p className='leading-relaxed text-cosmic-silver'>
            Explore how current planetary movements influence your natal chart.
            Transit analysis reveals timing for opportunities, challenges, and
            personal growth.
          </p>
          {!isValidDateRange && (
            <div className='mt-4 p-3 bg-yellow-900/20 border border-yellow-500/30 rounded-lg'>
              <p className='text-yellow-400 text-sm'>
                Please select a valid date range (max 1 year) to calculate
                transits.
              </p>
            </div>
          )}
        ...
        {hasResults && (
          <div className='mt-8 p-4 bg-cosmic-deep-purple/20 rounded-lg border border-cosmic-purple/20'>
            ...
            <p className='text-cosmic-silver text-sm'>
              Your transit analysis is ready. Use the tabs above to explore
              planetary transits and lunar cycles for your selected date range.
