...
const MAJOR_CITIES = [
  { name: 'New York, NY', lat: 40.7128, lon: -74.006, tz: 'America/New_York' },
  {
    name: 'Los Angeles, CA',
    lat: 34.0522,
    lon: -118.2437,
        ...
        birthData !== undefined && (
          <Card className='mb-6 bg-cosmic-gold/10 border-cosmic-gold/30'>
            <div className='flex items-center justify-between'>
              <div>
                <h4 className='text-cosmic-gold font-semibold mb-1'>
                  Current Birth Data
                </h4>
              ...
              {showAdvanced && (
                <div className='mt-4 grid grid-cols-1 md:grid-cols-3 gap-4'>
                  <div>
                    <label
                      htmlFor='birth-lat'
                      className='block text-cosmic-silver/70 font-medium mb-2'
                    >
                      Latitude
                    </label>
                    <input
