...
const HumanDesign: React.FC = () => {
  ...
  const formatBirthInfo = (
    birthInfo: HumanDesignData['birth_info']
  ): {
    date: string;
    time: string;
    coordinates: string;
    ...
    <div className='space-y-8'>
      ...
      <div className='text-center'>
        ...
        <p className='text-xl text-cosmic-silver/80'>
          Discover your unique energy type, strategy, and life purpose through
        ...
        isDataValid === true && (
          <div className='space-y-6'>
            ...
            <HumanDesignChart
              ...
              onHumanDesignCalculated={(hdData: HumanDesignData) =>
                    ...
                    return (
                      <>
                        ...
                        <div className='text-center'>
                          ...
                          <div className='text-cosmic-silver'>
                            {humanDesignData.birth_info.location.timezone}
                          </div>
                        </div>
                        <div className='text-center'>
                          <div className='text-cosmic-gold font-semibold'>
            ...
            <Card title='About Human Design'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='space-y-2 text-sm text-cosmic-silver'>
                    <div>
                      <span className='text-cosmic-gold'>Strategy:</span> Your
                      decision-making approach
                    </div>
                    <div>
                      <span className='text-cosmic-gold'>Authority:</span> Your
                      inner guidance system
                    </div>
                    <div>
                      <span className='text-cosmic-gold'>Profile:</span> Your
                      personality theme
                    </div>
                    <div>
                      <span className='text-cosmic-gold'>Centers:</span> Energy
                      hubs in your body
                    </div>
                    <div>
                      <span className='text-cosmic-gold'>Gates:</span> Specific
                      traits and gifts
                    </div>
                    <div>
                      <span className='text-cosmic-gold'>Channels:</span>{' '}
                      Consistent life forces
                    </div>
                  </div>
                </div>
              </div>
