    ...
    <div className='container mx-auto p-6 max-w-4xl space-y-6'>
      ...
      <Card title='Account Overview'>
        <div className='space-y-4' role='list' aria-label='Account details'>
          ...
          >
            <span id='email-label' className='text-cosmic-silver'>
              Email
            </span>
            <span
              className='text-cosmic-gold'
              aria-label={`User email address: ${user.email}`}
            >
              {user.email}
            </span>
          </div>
          ...
          >
            <span id='account-id-label' className='text-cosmic-silver'>
              Account ID
            </span>
            <span
              className='text-cosmic-gold font-mono text-sm'
              aria-label={`User account ID: ${user.uid.slice(0, 8)}...`}
            >
              {user.uid.slice(0, 8)}...
            </span>
          </div>
