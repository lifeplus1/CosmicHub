...
const mockBlogPosts: BlogPost[] = [
  {
    ...
    content:
      'Your Moon sign represents your emotional core, subconscious patterns, and instinctive reactions...',
    author: 'Christopher',
  ...
  },
  {
    ...
    content:
      'Venus returns are powerful periods for relationship renewal and value reassessment...',
    author: 'Christopher',
  ...
  },
  {
    ...
    excerpt:
      'Learn how your Human Design type influences your decision-making process and discover your unique strategy for navigating life.',
    content:
      'Human Design combines ancient wisdom with modern science to reveal your energetic blueprint...',
    author: 'Christopher',
  ...
  },
  {
    ...
    excerpt:
      'Uncover the hidden meaning behind your Life Path number and how it shapes your purpose and destiny.',
    content:
      "Your Life Path number is calculated from your birth date and reveals your soul's journey...",
    author: 'Christopher',
  ...
  },
  {
    ...
    excerpt:
      'Discover how contemplation transforms shadow into gift, and gift into siddhi in the Gene Keys system.',
    content:
      'The Gene Keys offer a contemplative approach to personal transformation...',
    author: 'Christopher',
  ...
  },
  {
    ...
    excerpt:
      'Navigate Mercury retrograde periods with confidence using practical tips and astrological insights.',
    content:
      "Mercury retrograde doesn't have to be a time of chaos and confusion...",
    author: 'Christopher',
  ...
  },
  {
    ...
    excerpt:
      'Understand the transformative power of your Saturn Return and how to work with this profound astrological milestone.',
    content:
      'Your Saturn Return marks a pivotal moment in your astrological journey...',
    author: 'Saturn Sage',
  ...
  },
  {
    ...
    excerpt:
      'Explore the fundamental elements of Human Design: Type, Strategy, Authority, and Profile.',
    content:
      'Human Design offers a unique blueprint for understanding your energetic makeup...',
    author: 'Design Maven',
  ...
  },
  {
    ...
    excerpt:
      'Discover how your numerological profile can guide you toward your ideal career and life purpose.',
    content:
      'Your numbers reveal profound insights about your professional calling...',
  ...
  },
  {
    ...
    excerpt:
      'Learn how to transform your greatest challenges into your highest gifts through the Gene Keys system.',
    content:
      'The Gene Keys present a beautiful map of consciousness evolution...',
    author: 'Key Keeper',
    ...
    <div className='max-w-7xl mx-auto px-4 py-8'>
      ...
      <div className='text-center mb-12'>
        ...
        <p className='text-xl text-cosmic-silver max-w-3xl mx-auto'>
          Explore the depths of astrology, numerology, human design, and cosmic
          wisdom through expert insights and practical guidance.
        </p>
      </div>
      ...
      <div className='bg-cosmic-blue/10 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-cosmic-silver/10'>
        ...
        {allTags.length > 0 && (
          <div className='mt-4 pt-4 border-t border-cosmic-silver/10'>
            <h3 className='text-sm font-semibold text-cosmic-gold mb-3'>
              Popular Tags:
            </h3>
      ...
      {featuredPosts.length > 0 && (
        <div className='mb-12'>
          <h2 className='text-2xl font-bold text-cosmic-gold mb-6 font-cinzel'>
            Featured Posts
          </h2>
              ...
              <article key={post.id} className='group relative'>
                ...
                >
                  ...
                  <div className='absolute top-4 left-4 z-10'>
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r ${categoryColors[post.category]} shadow-lg`}
                    >
                  ...
                  <div className='p-6'>
                    ...
                    <div className='mt-4 flex flex-wrap gap-2'>
                      {post.tags.slice(0, 3).map(tag => (
                        <span
                          key={tag}
                          className='px-2 py-1 bg-cosmic-silver/10 text-cosmic-silver/80 text-xs rounded-md'
                        >
                          #{tag}
                        </span>
                      ))}
              ...
              <article key={post.id} className='group'>
                ...
                >
                  ...
                  <div className='relative p-4 pb-0'>
                    <span
                      className={`inline-block px-2 py-1 rounded-md text-xs font-semibold text-white bg-gradient-to-r ${categoryColors[post.category]}`}
                    >
                      {categoryLabels[post.category]}
                    </span>
                  </div>
