    ...
    <div className='space-y-8'>
      ...
      <div className='text-center'>
        ...
        <p className='text-xl text-cosmic-silver/80'>
          Discover your unique genetic blueprint through the Gene Keys system -
          a contemplative path of consciousness evolution
        </p>
      </div>
          ...
          <Card title='About Gene Keys'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2 text-sm text-cosmic-silver'>
                  <div>
                    <span className='text-cosmic-gold'>Life&apos;s Work:</span>{' '}
                    Your primary life purpose
                  </div>
                  <div>
                    <span className='text-cosmic-gold'>Evolution:</span> Your
                    greatest challenge and growth
                  </div>
                  <div>
                    <span className='text-cosmic-gold'>Radiance:</span> How you
                    attract abundance
                  </div>
                  <div>
                    <span className='text-cosmic-gold'>Purpose:</span> Your
                    highest service to humanity
                  </div>
                  <div>
                    <span className='text-cosmic-gold'>
                      Shadow → Gift → Siddhi:
            ...
            <div className='mt-6 p-4 bg-cosmic-purple/20 border border-cosmic-purple/30 rounded-lg'>
              <h4 className='text-lg font-semibold text-cosmic-gold mb-2'>
                Contemplation Practice
              </h4>
              <p className='text-cosmic-silver/90'>
                Gene Keys are designed for deep contemplation over time. Allow
                weeks or months with each Gene Key, observing how its patterns
                show up in your life and naturally transform from shadow
                frequencies into gifts and eventually into the transcendent
                state of the Siddhi.
              </p>
            </div>
          </Card>
