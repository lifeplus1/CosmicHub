...
export const SubscriptionSuccessPage: React.FC = (): ReactElement => {
  ...
  const refreshSubscription: () => Promise<unknown> =
    useMemo((): (() => Promise<unknown>) => {
    ...
    void (async (): Promise<void> => {
      try {
        ...
        toast({
          title: 'Error',
          description:
            'Unable to verify subscription. Please contact support if issues persist.',
          status: 'error',
          duration: 5000,
          isClosable: true,
        });
        ...
        <div className='w-full max-w-md p-6 mx-4 bg-white rounded-lg shadow-lg'>
          ...
          <div className='space-y-4 text-center'>
            <p className='text-gray-600'>
              This page can only be accessed after a successful subscription
              purchase.
            </p>
            <Link
              to='/pricing'
            ...
            <div className='mb-8 bg-white border-2 border-green-200 rounded-lg shadow-lg'>
              <div className='p-6 text-white rounded-t-lg bg-gradient-to-r from-green-500 to-blue-500'>
                <div className='flex items-center justify-between'>
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-bold ${getTierColor(subscriptionDetails.tier)} text-white`}
                  >
                    Active
                  </span>
                </div>
