...
export function hasIndex<T>(arr: readonly T[] | T[] | undefined | null, index: number): arr is readonly T[] {
  return Array.isArray(arr) && index >= 0 && index < arr.length;
}

export function safeAt<T>(arr: readonly T[] | T[] | undefined | null, index: number): T | undefined {
  if (!Array.isArray(arr)) return undefined;
  return index >= 0 && index < arr.length ? arr[index] : undefined;
}

export function first<T>(arr: readonly T[] | T[] | undefined | null): T | undefined {
...
export function safeMap<T, R>(arr: readonly T[] | T[] | undefined | null, fn: (item: T, index: number) => R): R[] {
