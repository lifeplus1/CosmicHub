 ...
 */
export function extractNumericBirthData(
  bd: AnyIncomingBirthData | null | undefined
): NormalizedNumericBirthData | null {
...
export function toLibraryBirthStrings(
  data: NormalizedNumericBirthData | null | undefined
