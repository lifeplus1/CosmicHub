...
export const ZODIAC_SIGNS_CAPITALIZED = [
    'Aries',
    'Taurus',
    'Gemini',
    'Cancer',
 ...
 */
export function getSignFromDegrees(degrees) {
 ...
 */
export function getSignFromDegreesCapitalized(degrees) {
    const normalizedDegrees = ((degrees % 360) + 360) % 360;
    const signIndex = Math.floor(normalizedDegrees / 30);
 ...
 */
export function getDegreeWithinSign(degrees) {
    const normalizedDegrees = ((degrees % 360) + 360) % 360;
 ...
 */
export function calculateHousePosition(planetDegrees, houseCusps) {
 ...
 */
export function getElementFromSign(sign) {
 ...
 */
export function getQualityFromSign(sign) {
 ...
 */
export function getRulerFromSign(sign) {
 ...
 */
export function formatPlanetPosition(position, retrograde = false, precision = 2) {
...
export function isZodiacSign(value) {
    return (typeof value === 'string' && ZODIAC_SIGNS.includes(value));
}
export function isHouseNumber(value) {
    return (typeof value === 'number' &&
        Number.isInteger(value) &&
        value >= 1 &&
        value <= 12);
}
//# sourceMappingURL=astrologyUtils.js.map