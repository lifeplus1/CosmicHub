 ...
 */
export function categorizeBodies(
  bodies: Record<string, unknown>
): Record<CelestialBodyCategory, Record<string, unknown>> {
  const result: Record<CelestialBodyCategory, Record<string, unknown>> = {
    traditional_planets: {},
    modern_planets: {},
    major_asteroids: {},
    minor_asteroids: {},
 ...
 */
export function getPlanetsForDisplay(
  categorizedBodies: Record<CelestialBodyCategory, Record<string, unknown>>
 ...
 */
export function getAsteroidsForDisplay(
  categorizedBodies: Record<CelestialBodyCategory, Record<string, unknown>>
): Record<string, unknown> {
  return {
 ...
 */
export function getPointsForDisplay(
  categorizedBodies: Record<CelestialBodyCategory, Record<string, unknown>>
): Record<string, unknown> {
  return {
