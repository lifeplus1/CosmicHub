...
const FrequencyControls: React.FC<FrequencyControlsProps> = ({
  ...
  const [customFrequency, setCustomFrequency] =
    useState<number>(currentFrequency);
    ...
    <div className='space-y-6'>
      <Card className='bg-cosmic-dark/50'>
        <div className='space-y-4'>
          <h3 className='mb-4 text-lg font-semibold text-cosmic-gold'>
            Frequency Selection
          </h3>
          <div role='group' aria-labelledby={groupLabelId}>
            <div id={groupLabelId} className='block mb-2 text-cosmic-silver'>
              Preset Frequencies
            </div>
            <div
              ...
              onKeyDown={useCallback(
                (e: React.KeyboardEvent<HTMLDivElement>) => {
                  ...
                  const idx = presetFrequencies.findIndex(
                    p => p.value === currentFrequency
                  );
          ...
          <div>
            <label
              ...
              className='block mb-2 text-cosmic-silver'
            >
              Custom Frequency (Hz)
            </label>
            <div className='flex gap-2'>
              ...
              />
              <Button onClick={handleCustomFrequencySubmit}>Apply</Button>
            </div>
      ...
      <Card className='bg-cosmic-dark/50'>
        <div className='space-y-4'>
          ...
          <div className='text-center text-cosmic-silver'>
            <p>
              Current Frequency:{' '}
              <span className='text-cosmic-gold'>{currentFrequency} Hz</span>
            </p>
          </div>
        </div>
      </Card>
