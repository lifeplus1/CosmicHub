 ...
 */
export const focusLabelToCanonical = (
  label: string
 ...
 */
export const canonicalToFocusLabel = (
  canonical: InterpretationFocusArea
): string => {
  const entry = Object.entries(FOCUS_LABEL_TO_CANONICAL).find(
