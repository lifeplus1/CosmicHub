...
const GeneKeyItem = memo<{
  ...
  return (
    ...
    >
      ...
      {typeof geneKey.line_theme === 'string' &&
        geneKey.line_theme.length > 0 &&
        typeof geneKey.sphere_context === 'string' &&
        geneKey.sphere_context.length > 0 && (
    ...
    return (
      <div className='flex p-4 space-x-4 border border-blue-500 rounded-md bg-blue-900/50'>
        ...
        <p className='text-white/80'>
          Click on any Gene Key above to see detailed information about its
  ...
  return (
    <div className='cosmic-card'>
      <div className='p-4'>
        ...
        {typeof selectedKey.line_theme === 'string' &&
          selectedKey.line_theme.length > 0 &&
          typeof selectedKey.sphere_context === 'string' &&
          selectedKey.sphere_context.length > 0 && (
            <div className='mb-4 p-3 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border-l-4 border-purple-400'>
              <p className='text-sm font-semibold text-purple-800'>
                {selectedKey.sphere_context} Sphere - Line {selectedKey.line}:{' '}
                {selectedKey.line_theme}
              </p>
              <p className='text-xs text-purple-600 mt-1'>
                This is your contemplative theme for the{' '}
                {selectedKey.sphere_context.toLowerCase()} sphere of the Golden
                Path.
              </p>
            </div>
          )}
        ...
        <div className='grid grid-cols-3 gap-6'>
          <div className='p-4 border border-red-500 rounded-md bg-red-50'>
            ...
            <p className='text-sm text-gray-700'>
              The unconscious, reactive pattern that creates suffering and
              limitation.
            </p>
          </div>
      ...
      <div className='cosmic-card'>
        <div className='p-4'>
          ...
          <p className='mb-6 text-sm text-gray-700'>
            The Venus Sequence reveals the pathway to opening your heart through
            relationships.
          </p>
  ...
  return (
    <div className='cosmic-card'>
      <div className='p-4'>
        ...
        <p className='mb-6 text-sm text-gray-700'>
          The Activation Sequence focuses on grounding your core purpose through
          four primary Gene Keys.
        </p>

        <div className='grid grid-cols-2 gap-4'>
          {geneKeysData.activation.keys.map((key, index) => (
            <GeneKeyItem key={index} geneKey={key} onKeySelect={onKeySelect} />
          ))}
        </div>
      </div>
    </div>
    ...
    return (
      <div className='cosmic-card'>
        <div className='p-4'>
          ...
          <p className='mb-6 text-sm text-gray-700'>
            The Pearl Sequence awakens your prosperity consciousness and true
            service.
          </p>
          ...
          <div className='flex p-4 mt-6 space-x-4 border border-green-500 rounded-md bg-green-900/50'>
            ...
            <p className='text-white/80'>
              Remember: The Gene Keys are not about becoming something new, but
              about remembering and embodying what you already are at the
              deepest level.
            </p>
          </div>
        </div>
