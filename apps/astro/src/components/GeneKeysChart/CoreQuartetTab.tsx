        ...
        <div className='border cosmic-card bg-gradient-to-br from-golden-900/30 to-amber-900/30 border-golden-500/30'>
          <div className='p-6 text-center'>
            ...
            <p className='leading-relaxed text-cosmic-silver/80'>
              The four foundational Gene Keys that form the blueprint of your
              unique path in life. These keys work together to reveal your
              deepest purpose and highest potential.
            </p>
          </div>
        </div>
              ...
              >
                <div className='p-6'>
                  <div className='flex items-center mb-4'>
                    ...
                    <div>
                      <h4
                        className={`text-2xl font-bold text-${item.color}-400 group-hover:text-${item.color}-300 transition-colors`}
                      >
                        {item.title}
                      </h4>
                    ...
                    <div className='p-3 border rounded-lg bg-red-900/20 border-red-500/20'>
                      <div className='flex items-start'>
                        ...
                        <div>
                          ...
                          <span className='ml-2 text-sm text-cosmic-silver/90'>
                            {item.key.shadow}
                          </span>
                        </div>
                      </div>
        ...
        <div className='border cosmic-card bg-gradient-to-br from-indigo-900/20 to-purple-900/20 border-indigo-500/30'>
          <div className='p-6'>
            ...
            <div className='space-y-4 text-cosmic-silver/90'>
              <p>
                Your Core Quartet represents the foundational architecture of
                your consciousness. These four Gene Keys work together as an
                integrated system to guide your life&apos;s unfoldment and
                spiritual evolution.
              </p>
              ...
              <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                <div className='p-4 border rounded-lg bg-emerald-900/30 border-emerald-500/20'>
                  ...
                  <p className='text-sm'>
                    These work as a pair - your Life&apos;s Work shows your
                    natural gifts, while Evolution reveals where you&apos;ll
                    face resistance and ultimately breakthrough to mastery.
                  </p>
                </div>

                <div className='p-4 border rounded-lg bg-purple-900/30 border-purple-500/20'>
                  <h5 className='mb-2 font-bold text-purple-400'>
                    Radiance &amp; Purpose
                  </h5>
                  <p className='text-sm'>
                    Your Radiance attracts the resources you need to fulfill
                    your Purpose. As you embody your gifts, you naturally
                    magnetize opportunities for service.
                  </p>
                </div>
              </div>

              <div className='p-4 border rounded-lg bg-golden-900/30 border-golden-500/20'>
                <h5 className='mb-2 font-bold text-golden-400'>
                ...
                <ul className='space-y-2 text-sm'>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Contemplate one Gene Key per season (3-month cycles)
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-golden-400'>•</span>
                    <span>
                      Notice how the shadows of each key show up in your daily
                      life
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-golden-400'>•</span>
                    <span>
                      Allow the gifts to emerge naturally through acceptance,
                      not force
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-golden-400'>•</span>
                    <span>
                      Trust that your unique combination creates something new
                      in the world
                    </span>
                  </li>
                </ul>
