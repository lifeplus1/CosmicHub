      ...
      return (
        <div className='flex items-center justify-center h-64'>
          <p className='text-cosmic-silver/60'>
            No Venus Sequence data available
          </p>
        </div>
      );
    }
        ...
        <div className='border cosmic-card bg-gradient-to-br from-rose-900/20 to-pink-900/20 border-rose-500/30'>
          <div className='p-6'>
            ...
            <div className='space-y-4 text-cosmic-silver/90'>
              <p>
                The Venus Sequence governs your capacity for love,
                relationships, and emotional intelligence. These Gene Keys work
                together to show how you attract, give, and receive love in all
                its forms.
              </p>

              <div className='p-4 border rounded-lg bg-pink-900/30 border-pink-500/20'>
                <h5 className='mb-2 font-bold text-pink-400'>
                ...
                <ul className='space-y-2 text-sm'>
                  ...
                  <li className='flex items-start'>
                    <span className='mr-2 text-pink-400'>•</span>
                    <span>
                      Notice how these patterns show up in your relationships
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-pink-400'>•</span>
                    <span>
                      Practice moving from shadow to gift through acceptance
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-pink-400'>•</span>
                    <span>
                      Allow your heart&apos;s wisdom to guide your connections
                    </span>
                  </li>
                </ul>
              </div>
