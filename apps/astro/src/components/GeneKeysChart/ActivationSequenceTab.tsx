...
const ActivationSequenceTab: React.FC<ActivationSequenceTabProps> = React.memo(
  ({ geneKeysData, onKeySelect }) => {
    ...
    if (
      geneKeysData.activation === null ||
      geneKeysData.activation === undefined
    ) {
      return (
        <div className='flex items-center justify-center h-64'>
          <p className='text-cosmic-silver/60'>
            No Activation Sequence data available
          </p>
        </div>
      );
    }
            ...
            <div className='flex items-center mb-4'>
              ...
              <div>
                ...
                <p className='text-cosmic-silver/80'>
                  Intelligence Quotient (IQ) Sequence
                </p>
              </div>
            </div>
        ...
        <div className='border cosmic-card bg-gradient-to-br from-purple-900/20 to-blue-900/20 border-purple-500/30'>
          <div className='p-6'>
            ...
            <div className='space-y-4 text-cosmic-silver/90'>
              <p>
                The Activation Sequence focuses on developing your mental
                intelligence and cognitive abilities. This sequence helps you
                transform limiting mental patterns into gifts of clarity and
                wisdom.
              </p>

              <div className='p-4 border rounded-lg bg-blue-900/30 border-blue-500/20'>
                <h5 className='mb-2 font-bold text-blue-400'>
                  Practice Guidelines:
                </h5>
                <ul className='space-y-2 text-sm'>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Begin each day by contemplating one Gene Key from your
                      sequence
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-blue-400'>•</span>
                    <span>
                      Notice mental patterns and how they shift from shadow to
                      gift
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-blue-400'>•</span>
                    <span>
                      Journal insights about how these patterns show up in your
                      thinking
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-blue-400'>•</span>
                    <span>
                      Practice patience as transformation happens naturally over
                      time
                    </span>
                  </li>
                </ul>
