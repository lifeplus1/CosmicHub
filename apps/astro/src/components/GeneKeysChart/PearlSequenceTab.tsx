...
const SacredSequenceTab: React.FC<SacredSequenceTabProps> = React.memo(
  ({ geneKeysData, onKeySelect }) => {
    ...
    if (
      geneKeysData.pearl_sequence === null ||
      geneKeysData.pearl_sequence === undefined
    ) {
      return (
        <div className='flex items-center justify-center h-64'>
          <p className='text-cosmic-silver/60'>
            No Pearl Sequence data available
          </p>
        </div>
      );
    }
            ...
            <div className='flex items-center mb-4'>
              ...
              <div>
                ...
                <p className='text-cosmic-silver/80'>
                  Pearl Sequence - Spiritual Mastery
                </p>
              </div>
            </div>
        ...
        <div className='border cosmic-card bg-gradient-to-br from-indigo-900/20 to-purple-900/20 border-indigo-500/30'>
          <div className='p-6'>
            ...
            <div className='space-y-4 text-cosmic-silver/90'>
              <p>
                The Sacred Sequence represents the highest spiritual
                intelligence, focusing on your connection to universal
                consciousness. This sequence helps you transcend personal
                limitations and embody divine qualities.
              </p>
              ...
              <div className='p-4 border rounded-lg bg-purple-900/30 border-purple-500/20'>
                ...
                <ul className='space-y-2 text-sm'>
                  <li className='flex items-start'>
                    ...
                    <span>
                      Approach these Gene Keys with deep reverence and patience
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-purple-400'>•</span>
                    <span>
                      Practice meditation and stillness to receive their wisdom
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-purple-400'>•</span>
                    <span>
                      Allow years for each Gene Key to reveal its deepest
                      mysteries
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-purple-400'>•</span>
                    <span>
                      Notice how spiritual insights naturally arise from daily
                      practice
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-purple-400'>•</span>
                    <span>
                      Trust the intelligence of your own awakening process
                    </span>
                  </li>
                  <li className='flex items-start'>
                    <span className='mr-2 text-purple-400'>•</span>
                    <span>
                      Embody the Siddhis as lived experience, not concepts
                    </span>
                  </li>
                </ul>
              </div>
