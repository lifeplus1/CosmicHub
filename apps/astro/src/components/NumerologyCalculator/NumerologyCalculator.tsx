  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      const response = await fetch(
        `${apiConfig.baseUrl}/calculate-numerology`,
        {
          method: 'POST',
          headers: {
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          First Challenge (
                          {result.challenge_numbers.first_challenge.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-blue-500 rounded'>
                          {result.challenge_numbers.first_challenge.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.challenge_numbers.meanings.first}
                        </p>
                      </div>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          Second Challenge (
                          {result.challenge_numbers.second_challenge.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-blue-500 rounded'>
                          {result.challenge_numbers.second_challenge.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.challenge_numbers.meanings.second}
                        </p>
                      </div>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          Third Challenge (
                          {result.challenge_numbers.third_challenge.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-blue-500 rounded'>
                          {result.challenge_numbers.third_challenge.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.challenge_numbers.meanings.third}
                        </p>
                      </div>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          Fourth Challenge (
                          {result.challenge_numbers.fourth_challenge.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-blue-500 rounded'>
                          {result.challenge_numbers.fourth_challenge.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.challenge_numbers.meanings.fourth}
                        </p>
                      </div>
                    </div>
                  </Accordion.Content>
                  ...
                  <Accordion.Content className='pb-4'>
                    <div className='grid grid-cols-2 gap-4'>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          First Pinnacle (
                          {result.pinnacle_numbers.first_pinnacle.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-green-500 rounded'>
                          {result.pinnacle_numbers.first_pinnacle.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.pinnacle_numbers.meanings.first}
                        </p>
                      </div>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          Second Pinnacle (
                          {result.pinnacle_numbers.second_pinnacle.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-green-500 rounded'>
                          {result.pinnacle_numbers.second_pinnacle.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.pinnacle_numbers.meanings.second}
                        </p>
                      </div>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          Third Pinnacle (
                          {result.pinnacle_numbers.third_pinnacle.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-green-500 rounded'>
                          {result.pinnacle_numbers.third_pinnacle.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.pinnacle_numbers.meanings.third}
                        </p>
                      </div>
                      <div className='p-4 rounded-md bg-gray-50'>
                        <p className='mb-1 font-bold'>
                          Fourth Pinnacle (
                          {result.pinnacle_numbers.fourth_pinnacle.period})
                        </p>
                        <span className='px-2 py-1 mr-2 text-sm text-white bg-green-500 rounded'>
                          {result.pinnacle_numbers.fourth_pinnacle.number}
                        </span>
                        <p className='mt-2 text-sm'>
                          {result.pinnacle_numbers.meanings.fourth}
                        </p>
                      </div>
                    </div>
                  </Accordion.Content>
                ...
                <div className='p-4'>
                  <div className='flex items-center justify-between'>
                    <h3 className='font-bold text-md'>
                      Personal Year {result.personal_year.year}
                    </h3>
                    <span className='px-4 py-2 text-xl text-white bg-orange-500 rounded-full'>
                      {result.personal_year.number}
                    </span>
                  </div>
                  <p className='mt-4 text-cosmic-silver'>
                    {result.personal_year.meaning}
                  </p>
                </div>
              </div>
            </div>
              ...
              {result.karmic_numbers.karmic_debts.length > 0 && (
                <div className='p-4 border border-yellow-500 rounded-md bg-yellow-900/50'>
                  ...
                  <div className='flex flex-col space-y-1'>
                    {result.karmic_numbers.debt_meanings.map(
                      (meaning, index) => (
                ...
                <div className='p-4 border border-blue-500 rounded-md bg-blue-900/50'>
                  <div className='flex mb-2 space-x-4'>
                    ...
                    <div>
                      ...
                      <p className='text-white/80'>
                        Missing Numbers:{' '}
                        {result.karmic_numbers.karmic_lessons.join(', ')}
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col space-y-1'>
                    {result.karmic_numbers.lesson_meanings.map(
                      (meaning, index) => (
                        <p key={index} className='text-sm text-white/80'>
                          • {meaning}
                        </p>
                  ...
                  <div className='p-4 border border-green-500 rounded-md bg-green-900/50'>
                    <div className='flex space-x-4'>
                      ...
                      <div>
                        ...
                        <p className='text-white/80'>
                          You have no significant karmic debts or lessons
                          indicated in your numerology chart.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <Tabs.Content value='interpretation' className='p-4'>
            <div className='flex flex-col space-y-6'>
              {Object.entries(result.interpretation).map(([key, value]) => (
                <div
                  key={key}
                  className='border-l-4 border-purple-500 cosmic-card'
                >
                  <div className='p-4'>
                    <div className='flex flex-col space-y-2'>
