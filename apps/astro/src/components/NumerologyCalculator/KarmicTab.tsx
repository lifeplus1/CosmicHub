...
const KarmicTab: React.FC<KarmicTabProps> = ({ karmicNumbers }) => (
  <div className="flex flex-col p-4 space-y-6">
    {karmicNumbers.karmic_debts.length > 0 && (
      <KarmicDisplay type="debt" numbers={karmicNumbers.karmic_debts} meanings={karmicNumbers.debt_meanings} />
    )}
    {karmicNumbers.karmic_lessons.length > 0 && (
      <KarmicDisplay type="lesson" numbers={karmicNumbers.karmic_lessons} meanings={karmicNumbers.lesson_meanings} />
    )}
    {karmicNumbers.karmic_debts.length === 0 && karmicNumbers.karmic_lessons.length === 0 && (
