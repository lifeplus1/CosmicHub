        ...
        void (async () => {
          try {
            ...
            if (response.status === 200) {
              const data =
                (await response.json()) as unknown as ReverseGeocodeResponse; // typed response
              ...
              if (locationString !== '') {
                ...
                setValidationErrors({
                  birthLocation:
                    'Could not determine location name. Please enter manually.',
                });
              }
            } else {
              setValidationErrors({
  ...
  return (
    <Card title={title}>
      ...
      >
        ...
        <div>
          <label htmlFor='birth-date' className='block text-cosmic-silver mb-2'>
            Birth Date
          </label>
          <input
            id='birth-date'
        ...
        <div>
          <label htmlFor='birth-time' className='block text-cosmic-silver mb-2'>
            Birth Time
          </label>
          <input
            id='birth-time'
            ...
            <div className='flex items-start gap-2'>
              ...
              <div className='text-sm'>
                ...
                <ul className='text-cosmic-silver/80 space-y-1 text-xs'>
                  <li>
                    • Use exact birth time from birth certificate for accuracy
                  </li>
                  <li>• Include state/province for better location matching</li>
                  <li>
                    • Click &quot;Current&quot; to use your current location as
                    reference
                  </li>
                </ul>
              </div>
