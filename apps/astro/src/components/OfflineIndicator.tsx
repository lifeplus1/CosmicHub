...
import { getOfflineSyncManager, type NetworkStatus, type SyncResult } from '@cosmichub/storage';
...
export const OfflineIndicator: React.FC<OfflineIndicatorProps> = ({ 
  ...
  const getStatusText = (): string => {
    ...
    if (syncStats.pending_items > 0) return `${syncStats.pending_items} pending`;
    return 'Online';
  };
