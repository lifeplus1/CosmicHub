...
const NavLink: React.FC<NavLinkProps> = React.memo(
  ({ to, icon: Icon, label, tooltip, tier }) => {
...
const DropdownNav: React.FC<DropdownNavProps> = React.memo(
  ...
  const coreNavItems: NavItem[] = [
    {
      ...
      tooltip: {
        title: 'Home',
        description:
          'Your personal cosmic dashboard with personalized insights.',
      },
    },
    {
      to: '/chart',
      ...
      tooltip: {
        ...
        description:
          'Explore your birth chart with beautiful D3.js visualizations and interactive elements.',
      },
    },
    {
      to: '/blog',
      ...
      tooltip: {
        ...
        description:
          'Explore astrology, numerology, human design, and cosmic wisdom through expert articles.',
      },
    },
  ];
  ...
  const chartingTools: NavItem[] = [
    {
      ...
      tooltip: {
        title: 'Chart Calculator',
        description:
          'Calculate natal charts, transits, and progressions with precise astronomical data.',
      },
    },
    {
      to: '/multi-system',
      ...
      tooltip: {
        ...
        description:
          'Compare Western, Vedic, Chinese, and other astrological systems side by side.',
      },
    },
    ...(user !== null
      ? [
          {
            ...
            tooltip: {
              title: 'Saved Charts',
              description:
                'Access and manage your collection of saved astrological charts.',
            },
          },
        ]
      : []),
  ...
  const personalInsights: NavItem[] = [
    {
      ...
      tooltip: {
        ...
        description:
          'Discover your life path number, destiny number, and numerological patterns.',
      },
    },
    {
      to: '/human-design',
      ...
      tooltip: {
        ...
        description:
          'Explore your Human Design chart and discover your type, strategy, and authority.',
      },
    },
    {
      to: '/gene-keys',
      ...
      ? [
          {
            ...
            tooltip: {
              ...
              description:
                'Analyze relationship compatibility through comprehensive chart comparison.',
              tier: 'premium' as const,
            },
          },
          {
            ...
            tooltip: {
              ...
              description:
                'Get personalized interpretations powered by advanced AI technology.',
              tier: 'elite' as const,
            },
          },
        ]
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-16'>
          ...
          <div className='hidden md:flex items-center gap-4'>
            <Suspense
              fallback={
                <div className='w-24 h-10 bg-cosmic-purple/20 rounded-lg animate-pulse' />
              }
            >
                ...
                <div className='flex items-center gap-3'>
                  <NavLink
                    ...
                    tooltip={{
                      title: 'Sign In',
                      description:
                        'Access your account and unlock premium astrological features.',
                    }}
                  />
                  <button
                    ...
                    >
                      <NavLink
                        ...
                        tooltip={{
                          title: 'Sign In',
                          description:
                            'Access your account and premium features.',
                        }}
                      />
                    </div>
                    <button
