...
const BlogAuthor: React.FC<BlogAuthorProps> = ({
  ...
  return (
    <div
      className={`bg-cosmic-blue/10 rounded-xl p-6 border border-cosmic-silver/10 ${className}`}
    >
      <div className='flex items-start gap-4'>
        ...
        <div className='flex-1'>
          ...
          {/* Expertise Tags */}
          <div className='mb-4'>
            <h4 className='text-sm font-semibold text-cosmic-silver mb-2'>
              Expertise:
            </h4>
    ...
    <div className='max-w-4xl mx-auto px-4 py-8'>
      <div className='text-center mb-12'>
        ...
        <p className='text-xl text-cosmic-silver max-w-3xl mx-auto'>
          Our team of expert practitioners brings decades of experience in
          astrology, numerology, human design, and consciousness exploration.
        </p>
      </div>
      ...
      <div className='mt-16 text-center'>
        <div className='bg-gradient-to-r from-cosmic-purple/20 to-cosmic-blue/20 rounded-2xl p-8 border border-cosmic-silver/10'>
          ...
          <p className='text-cosmic-silver mb-6 max-w-2xl mx-auto'>
            Are you passionate about astrology, numerology, human design, or
            consciousness studies? We&apos;d love to feature your insights on
            our blog.
          </p>
          <Link
            to='/contact'
