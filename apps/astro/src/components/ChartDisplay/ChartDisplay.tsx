...
const ChartDisplayComponent: React.FC<ChartDisplayProps> = ({
  ...
  const processedSections =
    useMemo<ProcessedSections>((): ProcessedSections => {
      ...
      const sections = {
        planets: isValidArray<ChartDisplayPlanet>(planetsArray)
          ? planetsArray
          : [],
      ...
      const enrichedAngles = anglesArray.map((a): ChartDisplayAngle => {
        ...
        if (a.name === 'Ascendant' && housesArray.length >= 1) {
          ...
          return { ...a, sign: getSignFromDegree(pos), degree: pos % 30 };
        }
          ...
          <CardContent className='p-6 space-y-8 text-cosmic-silver'>
            ...
            {processedSections.planets.length > 0 && (
              <Card className='cosmic-glass border-cosmic-purple/30'>
                ...
                <CardContent className='p-0'>
                  <PlanetTable
                    data={processedSections.planets.map(
                      (
                        p
                      ): {
                        name: string;
            ...
            {processedSections.aspects.length > 0 && (
              <Card className='cosmic-glass border-cosmic-purple/30'>
                ...
                <CardContent className='p-0'>
                  <AspectTable
                    data={processedSections.aspects.map(
                      (
                        a
                      ): {
                        planet1: string;
            ...
            <Card className='cosmic-glass border-cosmic-purple/30'>
              ...
              <CardContent className='p-0'>
                <table
                  className='w-full text-cosmic-silver'
                  aria-describedby='house-table-caption'
                >
                  <caption id='house-table-caption' className='sr-only'>
                    Table of astrological house cusps with sign, degree and
                    ruling planet
                  </caption>
                  <thead className='bg-cosmic-purple/30 border-b border-cosmic-purple/30'>
                    <tr>
                      <th
                        scope='col'
                        className='px-4 py-3 text-left text-sm font-semibold text-cosmic-gold'
                      >
                        House
                      </th>
                      <th
                  ...
                  <tbody>
                    {processedSections.houses.map((house, index) => (
                      <tr
                        key={`house-${index}`}
                        className='border-t border-cosmic-purple/20 hover:bg-cosmic-purple/10 transition-colors'
                      >
                        ...
                        <td className='px-4 py-3 text-sm font-medium text-cosmic-gold'>
                          <span className='flex items-center gap-2'>
                            <span
                              ...
                              title={
                                house.ruler !== null &&
                                house.ruler !== undefined &&
                                typeof house.ruler === 'string' &&
                                house.ruler.length > 0
                                  ? house.ruler
                                  : undefined
                              }
                            >
            ...
            {processedSections.asteroids.length > 0 && (
              <Card className='cosmic-glass border-cosmic-purple/30'>
                ...
                <CardContent className='p-0'>
                  <table
                    className='w-full text-cosmic-silver'
                    aria-describedby='asteroid-table-caption'
                  >
                    <caption id='asteroid-table-caption' className='sr-only'>
                      Table of asteroid and minor body positions with sign,
                      degree and house
                    </caption>
                    <thead className='bg-cosmic-purple/30 border-b border-cosmic-purple/30'>
                      <tr>
                          ...
                          <td className='px-4 py-3 text-sm font-medium text-cosmic-silver'>
                            <span className='flex items-center gap-2'>
                              <span
                                ...
                                title={asteroid.name}
                              >
                                {getAsteroidSymbol(asteroid.name)}
                              </span>
            ...
            {processedSections.angles.length > 0 && (
              <Card className='cosmic-glass border-cosmic-purple/30'>
                ...
                <CardContent className='p-0'>
                  <table
                    className='w-full text-cosmic-silver'
                    aria-describedby='angles-table-caption'
                  >
                    <caption id='angles-table-caption' className='sr-only'>
                      Table of chart angles with sign and degree
                    </caption>
                    <thead className='bg-cosmic-purple/30 border-b border-cosmic-purple/30'>
                      <tr>
                        <th
                    ...
                    <tbody>
                      {processedSections.angles.map(
                        (angle, index: number): React.ReactElement => (
                          <tr
                            key={`angle-${index}`}
                            className='border-t border-cosmic-purple/20 hover:bg-cosmic-purple/10 transition-colors'
                          >
                            <td className='px-4 py-3 text-sm font-medium text-cosmic-silver'>
                              <span className='flex items-center gap-2'>
                                <span
                                  className='text-cosmic-gold text-xl'
                                  title={angle.name}
                                >
                                  {getPlanetSymbol(angle.name)}
                                </span>
