    ...
    <div className="max-w-6xl py-8 mx-auto">
      <div className="flex flex-col space-y-8">
        <div className="space-y-4 text-center">
          <h2 className="text-3xl font-bold text-purple-600">Understanding Human Design & Gene Keys</h2>
              ...
              <Accordion.Item value="what-is" className="border-b border-cosmic-silver/20">
                ...
                <Accordion.Content className="p-4">
                  <div className="flex flex-col space-y-4">
                    ...
                    <p className="font-bold text-cosmic-silver">Core Components:</p>
                    <ul className="pl-4 space-y-2">
                      <li className="flex items-center">
                        <FaDna className="mr-2 text-blue-500" />
                        <span><strong>Type:</strong> Your energy configuration (Manifestor, Generator, Manifesting Generator, Projector, Reflector)</span>
                      </li>
                      <li className="flex items-center">
                      ...
                      <li className="flex items-center">
                        ...
                        <span><strong>Authority:</strong> Your inner decision-making process</span>
                      </li>
                      <li className="flex items-center">
                        <FaBrain className="mr-2 text-blue-500" />
                        <span><strong>Centers:</strong> Nine energy centers that process life force</span>
                      </li>
                    </ul>
                  </div>
                </Accordion.Content>
                ...
                <Accordion.Content className="p-4">
                  <div className="grid grid-cols-1 gap-4">
                    <div className="p-4 border border-red-200 rounded-md bg-red-50/95">
                      <h5 className="mb-2 font-bold text-red-600 text-md">Manifestor (9%)</h5>
                      <p className="mb-2 text-sm text-gray-700"><strong>Strategy:</strong> Inform before you act</p>
                    ...
                    <div className="p-4 border border-orange-200 rounded-md bg-orange-50/95">
                      <h5 className="mb-2 font-bold text-orange-600 text-md">Generator (37%)</h5>
                      <p className="mb-2 text-sm text-gray-700"><strong>Strategy:</strong> Respond to opportunities</p>
                      <p className="text-sm text-gray-700">
                        Builders who thrive by responding to life’s opportunities with sustainable energy.
                      </p>
                    </div>
                    <div className="p-4 border border-yellow-200 rounded-md bg-yellow-50/95">
                      <h5 className="mb-2 font-bold text-yellow-600 text-md">Manifesting Generator (33%)</h5>
                      <p className="mb-2 text-sm text-gray-700"><strong>Strategy:</strong> Respond, then inform</p>
                      <p className="text-sm text-gray-700">
                        Multi-talented creators who combine initiation and response for dynamic impact.
                      </p>
                    </div>
                    <div className="p-4 border border-green-200 rounded-md bg-green-50/95">
                      <h5 className="mb-2 font-bold text-green-600 text-md">Projector (20%)</h5>
                      <p className="mb-2 text-sm text-gray-700"><strong>Strategy:</strong> Wait for invitation</p>
                      <p className="text-sm text-gray-700">
                        Guides who excel at directing others when invited into roles of leadership.
                      </p>
                    </div>
                    <div className="p-4 border border-blue-200 rounded-md bg-blue-50/95">
                      <h5 className="mb-2 font-bold text-blue-600 text-md">Reflector (1%)</h5>
                      <p className="mb-2 text-sm text-gray-700"><strong>Strategy:</strong> Wait a lunar cycle</p>
                      <p className="text-sm text-gray-700">
                        Mirrors of the community, reflecting the health of their environment over time.
                      </p>
                    </div>
                  </div>
                </Accordion.Content>
        ...
        <div className="cosmic-card">
          <div className="p-6">
            <h3 className="mb-4 text-xl font-bold text-center">Integration & Synthesis</h3>
            <div className="flex flex-col space-y-6">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="flex flex-col space-y-4">
                  <h4 className="font-bold text-blue-600 text-md">Human Design Provides:</h4>
                ...
                <div className="flex flex-col space-y-4">
                  <h4 className="font-bold text-purple-600 text-md">Gene Keys Provides:</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-sm text-cosmic-silver">
              ...
              <div className="flex p-4 space-x-4 border border-blue-500 rounded-md bg-blue-900/50">
                ...
                <div className="flex flex-col space-y-2">
                  <p className="font-bold text-cosmic-silver">Recommended Approach:</p>
