...
const planets: Planet[] = [
  ...
  { name: 'Jupiter', symbol: '♃', meaning: 'Growth, expansion, wisdom, luck' },
  {
    name: 'Saturn',
    symbol: '♄',
    meaning: 'Structure, discipline, lessons, karma',
  },
  {
    name: 'Uranus',
    symbol: '♅',
  ...
  },
  {
    name: 'Neptune',
    symbol: '♆',
    meaning: 'Spirituality, dreams, illusion, intuition',
  },
  {
    name: 'Pluto',
    symbol: '♇',
    meaning: 'Transformation, power, rebirth, depth',
  },
];
          ...
          <div key={index} className='cosmic-card rounded-xl shadow-lg'>
            <div className='p-4 pt-2'>
              <div className='flex items-center space-x-2 mb-2'>
                ...
                <h4 className='text-md font-bold text-gold-300'>
                  {planet.name}
                </h4>
              </div>
