...
const aspects: Aspect[] = [
  {
    ...
    description: 'Blends energies powerfully',
  },
  {
    name: 'Sextile',
    symbol: '⚹',
    degree: 60,
    nature: 'Harmonious',
    description: 'Opportunities and flow',
  },
  {
    name: 'Square',
    symbol: '□',
    degree: 90,
    nature: 'Challenging',
    description: 'Tension and growth',
  },
  {
    name: 'Trine',
    symbol: '△',
    degree: 120,
    nature: 'Harmonious',
    description: 'Natural talents and ease',
  },
  {
    name: 'Opposition',
    symbol: '☍',
    degree: 180,
    nature: 'Challenging',
    description: 'Balance and awareness',
  },
];
          ...
          <Accordion.Item key={index} value={index.toString()}>
            ...
            <Accordion.Content className='p-4'>
              <div className='flex flex-col space-y-2'>
                <span
                  className={`px-2 py-1 rounded text-xs ${aspect.nature.includes('Harmonious') ? 'bg-green-500/20 text-green-500' : 'bg-red-500/20 text-red-500'}`}
                >
                  {aspect.nature}
                </span>
