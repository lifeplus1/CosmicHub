            ...
            <div className='p-0 overflow-y-auto'>
              ...
              >
                ...
                >
                  <Tabs.Trigger
                    value='0'
                    className='px-4 py-4 data-[state=active]:text-gold-300 data-[state=active]:border-b-2 data-[state=active]:border-gold-300 text-cosmic-silver/60 font-semibold text-sm'
                  >
                    Fundamentals
                  </Tabs.Trigger>
                  <Tabs.Trigger
                ...
                <Suspense
                  fallback={
                    <div className='mx-auto mt-6 text-4xl text-purple-500 animate-spin'>
                      ⭐
                    </div>
                  }
                >
