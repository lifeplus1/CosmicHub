...
const signs: Sign[] = [
  {
    ...
    element: 'Fire',
    modality: 'Cardinal',
    traits: 'Energetic, pioneering, assertive',
  },
  {
    name: 'Taurus',
    element: 'Earth',
    modality: 'Fixed',
    traits: 'Stable, sensual, persistent',
  },
  {
    name: 'Gemini',
    element: 'Air',
  ...
  },
  {
    ...
    element: 'Air',
    modality: 'Cardinal',
    traits: 'Harmonious, diplomatic, social',
  },
  {
    name: 'Scorpio',
    element: 'Water',
    modality: 'Fixed',
    traits: 'Intense, transformative, passionate',
  },
  {
    name: 'Sagittarius',
    element: 'Fire',
...
const SignsTab: React.FC = React.memo(() => {
  return (
    <div className='flex flex-col space-y-6'>
      <h3 className='mb-4 text-2xl font-bold text-gold-300'>
        The 12 Zodiac Signs
      </h3>
        ...
        {signs.map((sign, index) => (
          <div key={index} className='shadow-lg cosmic-card rounded-xl'>
            <div className='p-4 pt-2'>
              <h4 className='mb-3 font-bold text-md text-gold-300'>
                {sign.name}
              </h4>
              <div className='flex mb-3 space-x-2'>
                {(() => {
                  ...
                  return (
                    <span
                      className={`px-2 py-1 rounded text-xs bg-${color}/20 text-${color}`}
                    >
                      {sign.element}
                    </span>
                  );
