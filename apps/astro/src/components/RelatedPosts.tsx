  ...
  return (
    <div className='mt-16 pt-8 border-t border-cosmic-silver/20'>
      ...
      <p className='text-cosmic-silver/80 mb-8'>
        Explore more insights hand-picked based on your interests in{' '}
        {categoryLabels[
          currentCategory as keyof typeof categoryLabels
        ].toLowerCase()}{' '}
        and related cosmic wisdom.
      </p>
                  ...
                  {hasSharedTags && (
                    <div className='mb-3'>
                      <div className='flex flex-wrap gap-1'>
                        <span className='text-xs text-cosmic-silver/60 mr-1'>
                          Shared:
                        </span>
