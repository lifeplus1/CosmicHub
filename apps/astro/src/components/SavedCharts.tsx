          ...
          <div className='py-16 text-center'>
            <div className='max-w-md p-8 mx-auto cosmic-card'>
              ...
              <p className='text-sm cosmic-text opacity-80'>
                Calculate your first chart to get started on your astrological
                journey!
              </p>
            </div>
          </div>
                    ...
                    <div className='flex items-start justify-between gap-3'>
                      <h3 className='flex-1 text-lg font-semibold text-gray-900 line-clamp-2'>
                        {chart.name !== null && chart.name !== ''
                          ? chart.name
                          : chart.birth_data !== null &&
                              chart.birth_data !== undefined &&
                              typeof chart.birth_data.city === 'string' &&
                              chart.birth_data.city !== ''
                    ...
                    <div className='space-y-3'>
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        <span className='flex-1 text-sm font-medium text-gray-700 truncate'>
                          {chart.birth_location !== null &&
                          chart.birth_location !== undefined &&
