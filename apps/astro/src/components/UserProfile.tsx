        ...
        <div className="p-6">
          ...
          <Tabs.Root defaultValue="overview">
            <Tabs.List className="flex mb-6 border-b border-cosmic-silver/30" aria-label="User Profile Tabs">
              <Tabs.Trigger value="overview" className="px-4 py-2 data-[state=active]:bg-cosmic-purple/20 data-[state=active]:text-cosmic-purple">
                Overview
              </Tabs.Trigger>
              <Tabs.Trigger value="usage" className="px-4 py-2 data-[state=active]:bg-cosmic-purple/20 data-[state=active]:text-cosmic-purple">
                Usage
              </Tabs.Trigger>
              <Tabs.Trigger value="account" className="px-4 py-2 data-[state=active]:bg-cosmic-purple/20 data-[state=active]:text-cosmic-purple">
                Account
              </Tabs.Trigger>
            </Tabs.List>
                  ...
                  <div className="p-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                      <div>
                        ...
                        <p className="text-2xl font-bold">{userStats.totalCharts}</p>
                      </div>
                      <div>
                        <p className="text-cosmic-silver">Charts This Month</p>
                        <p className="text-2xl font-bold">{userStats.chartsThisMonth}</p>
                      </div>
                      <div>
                        <p className="text-cosmic-silver">Saved Charts</p>
                        <p className="text-2xl font-bold">{userStats.savedCharts}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="px-2 py-1 text-sm text-gray-500 rounded bg-gray-500/20">Not Set Up</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="px-2 py-1 text-sm text-gray-500 rounded bg-gray-500/20">Disabled</span>
                      </div>
                      <div className="flex justify-between">
