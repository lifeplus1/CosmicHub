              ...
              <div className='flex justify-between'>
                <div className='flex items-center space-x-4'>
                  ...
                  <p className='font-bold text-cosmic-silver'>
                    {formData.city} • {formData.month}/{formData.day}/
                    {formData.year} • {formData.hour}:
                    {formData.minute.padStart(2, '0')} {formData.timezone}
                  </p>
                </div>
              </div>
            </div>
  ...
  return (
    <div className='max-w-2xl py-10 mx-auto'>
      <div className='cosmic-card'>
        <div className='p-6'>
          <h2 className='mb-6 text-2xl font-bold text-center text-cosmic-gold'>
            ...
            <div className='flex flex-col space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <label htmlFor='hour' className='block mb-2 text-cosmic-gold'>
                    Hour (24h) <span aria-hidden='true'>*</span>
                  </label>
                  <input
                    id='hour'
                    name='hour'
                ...
                <div>
                  <label
                    ...
                    className='block mb-2 text-cosmic-gold'
                  >
                    Minute <span aria-hidden='true'>*</span>
                  </label>
                  <input
                    id='minute'
                    name='minute'
              ...
              <div>
                <label htmlFor='city' className='block mb-2 text-cosmic-gold'>
                  Birth City <span aria-hidden='true'>*</span>
                </label>
                <input
                  id='city'
                  name='city'
          ...
          <div className='flex p-4 mt-6 space-x-4 border border-blue-500 rounded-md bg-blue-900/50'>
            ...
            <div className='flex flex-col space-y-2'>
              <p className='text-sm font-bold text-cosmic-silver'>
                Why both systems?
              </p>
              <p className='text-sm text-cosmic-silver'>
                Human Design provides your mechanical operating instructions,
                while Gene Keys offers the contemplative path for consciousness
                evolution. Together, they create a complete map for living your
                authentic purpose.
              </p>
            </div>
          </div>
