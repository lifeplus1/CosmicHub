...
export function isChartPreferencesData(value: unknown): value is ChartPreferencesData {
  ...
  const hasValidHouseSystem = 
    ...
    (data.houseSystem === 'placidus' || data.houseSystem === 'whole-sign' || data.houseSystem === 'equal-house');
  ...
  return hasValidChartStyle && hasValidHouseSystem && hasValidNotifications && hasValidTheme;
}
