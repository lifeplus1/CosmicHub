...
vi.mock('../utils/astrologyUtils', () => ({
  ...
  getRulerFromSign: (sign: string) => 'mars' // Simple mock
}));
...
describe('Chart Data Processing', () => {
  const mockBackendResponse = {
    ...
    aspects: [
      { point1: 'sun', point2: 'moon', aspect: 'trine', orb: 5.2, applying: true }
    ],
    angles: {
      ascendant: 0,
      mc: 90,
...
describe('Data Format Conversion', () => {
  it('should convert ChartData format to AstrologyChart format for serialization', () => {
    const mockChartData: Partial<ChartData> = {
      planets: {
        sun: { name: 'sun', position: 280.5, sign: 'capricorn', house: 10, retrograde: false, speed: 1.0 },
        moon: { name: 'moon', position: 125.3, sign: 'leo', house: 4, retrograde: false, speed: 13.2 },
        mercury: { name: 'mercury', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        venus: { name: 'venus', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        mars: { name: 'mars', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        jupiter: { name: 'jupiter', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        saturn: { name: 'saturn', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        uranus: { name: 'uranus', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        neptune: { name: 'neptune', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        pluto: { name: 'pluto', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        chiron: { name: 'chiron', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        north_node: { name: 'north_node', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 },
        south_node: { name: 'south_node', position: 0, sign: 'aries', house: 1, retrograde: false, speed: 0 }
      },
      asteroids: {
        chiron: { name: 'chiron', position: 251.6, sign: 'sagittarius', house: 8, retrograde: false, speed: 0.02 }
      },
      points: {
        north_node: { name: 'north_node', position: 125.0, sign: 'leo', house: 4, retrograde: true, speed: -0.05 }
      }
    };
    ...
    const convertToAstrologyChart = (chartData: ChartData) => {
      return {
        ...
        angles: Object.entries(chartData.angles || {}).map(([name, position]) => ({
          name,
    ...
    expect(converted.planets.length).toBe(2);
