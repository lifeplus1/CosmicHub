try {
  (() => {
    ...
    var Q = le((J, K) => {
      ...
      f();
      (function (e) {
        if (typeof J == 'object' && typeof K < 'u') K.exports = e();
        ...
        return (function r(i, d, s) {
          ...
          for (var t = typeof O == 'function' && O, u = 0; u < s.length; u++)
            n(s[u]);
          return n;
        })(
          {
            ...
            3: [
              function (r, i, d) {
                ...
                i.exports = function (c) {
                  ...
                  return function (b) {
                    var m = function () {
                      ...
                      for (k = 0; k < A; k++) {
                        if (
                          ((L[k] = { cacheItem: _, arg: arguments[k] }),
                          _.has(arguments[k]))
                        ) {
                          _ = _.get(arguments[k]);
                          continue;
                      ...
                      return (
                        ...
                        R ||
                          ...
                          _.set(arguments[A], P)),
                        c > 0 &&
                          ((L[A] = { cacheItem: _, arg: arguments[A] }),
                          R ? n(l, L) : l.push(L),
                ...
                function n(c, I) {
                  ...
                  for (_ = 0; _ < l; _++) {
                    for (m = !0, E = 0; E < b; E++)
                      if (!u(c[_][E].arg, I[E].arg)) {
                        m = !1;
                        break;
                      }
                    if (m) break;
                  }
                  c.push(c.splice(_, 1)[0]);
                }
                function t(c) {
                  var I = c.length,
                    l = c[I - 1],
                  ...
                  for (
                    ...
                    m >= 0 &&
                    ((l = c[m]), (b = l.cacheItem.get(l.arg)), !b || !b.size);
                    m--
                  )
...
`)),
    ...
    var te = 'storybook/background',
      ...
      ne = (0, z.default)(1e3)((e, o, a, r, i, d) => ({
        id: e || o,
        title: o,
        onClick: () => {
          i({ selected: a, name: o });
