try {
  (() => {
    ...
    var On = __STORYBOOK_COMPONENTS__,
      {
        A: Tn,
        ActionBar: Ie,
        AddonPanel: Sn,
    ...
    function x(e) {
      ...
      var i = _t.exec(t.substring(0, 50));
      if (i)
        return {
          red: parseInt('' + i[1], 10),
      ...
      var d = Ot.exec(t.substring(0, 50));
      if (d) {
        var E = parseInt('' + d[1], 10),
          m = parseInt('' + d[2], 10) / 100,
          _ = parseInt('' + d[3], 10) / 100,
          y = 'rgb(' + F(E, m, _) + ')',
          I = re.exec(y);
        if (!I) throw new T(4, t, y);
        return {
          red: parseInt('' + I[1], 10),
          green: parseInt('' + I[2], 10),
          blue: parseInt('' + I[3], 10),
    ...
    function $e(e, t, r) {
      return function () {
        ...
        return a.length >= t ? e.apply(this, a) : $e(e, t, a);
      };
    }
    function S(e) {
      return $e(e, e.length, []);
    ...
    function xt(e, t) {
      if (t === 'transparent') return t;
      var r = A(t);
      return C(O({}, r, { lightness: P(0, 1, r.lightness - parseFloat(e)) }));
    }
    var gl = S(xt);
    function Pt(e, t) {
      if (t === 'transparent') return t;
      var r = A(t);
      return C(O({}, r, { saturation: P(0, 1, r.saturation - parseFloat(e)) }));
    }
    var hl = S(Pt);
    function Dt(e, t) {
      if (t === 'transparent') return t;
    ...
    function Ft(e, t) {
      ...
      var r = x(t),
        ...
        a = O({}, r, { alpha: P(0, 1, (n * 100 + parseFloat(e) * 100) / 100) });
      return Y(a);
    }
    var Ht = S(Ft),
      qe = Ht;
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Ke = ({
        ...
        return o.createElement(
          ...
          t &&
            o.createElement(_r, null, o.createElement(yr, { sortAscending: e }))
        );
      },
      Or = ({
        ...
        let u = v('TableInspectorHeaderContainer'),
      ...
      Tr = ({ data: e, columns: t }) => {
        let r = v('TableInspector'),
          ...
          u = w(() => {
            l(({ sortIndexColumn: m, sortAscending: _ }) => ({
              sorted: !0,
              sortIndexColumn: !0,
              sortColumn: void 0,
              sortAscending: m ? !_ : !0,
          ...
          c = w(m => {
            l(({ sortColumn: _, sortAscending: y }) => ({
              sorted: !0,
              sortIndexColumn: !1,
              sortColumn: m,
              sortAscending: m === _ ? !y : !0,
            }));
          }, []);
        ...
        if (
          (i !== void 0
            ? (E = d.map((m, _) =>
                typeof m == 'object' && m !== null ? [m[i], _] : [void 0, _]
              ))
            : a && (E = p.map((m, _) => [p[_], _])),
          E !== void 0)
        ) {
          let m = (y, I) => (ut, ct) => {
            ...
            _ = E.sort(m(y => y[0], s)).map(y => y[1]);
          ((p = _.map(y => p[y])), (d = _.map(y => d[y])));
        }
        return o.createElement(
          'div',
          { style: r.base },
      ...
      Mr = B.div({ flex: 1, padding: '0 0 0 5px' }),
      lt = ve(({ children: e, className: t }, r) =>
        o.createElement(
          Le,
            ...
            o.createElement(
              ...
              e.map(i =>
                o.createElement(
                  Pr,
                  { key: i.id },
                  i.count > 1 && o.createElement(Dr, null, i.count),
                  o.createElement(
                    Mr,
                    null,
                    o.createElement(Fr, {
      ...
      return (
        ...
        o.createElement(
          ...
          o.createElement(
            ...
            e === 0 ? '' : o.createElement(we, { status: 'neutral' }, e)
          )
        )
      );
    }
