  ...
  ({
    ...
    const initializeAudio = useCallback(async () => {
      try {
        ...
        audioLogger.error('Failed to initialize audio context', { error });
      }
    }, []);
    ...
    const createAudioNodes = useCallback(() => {
      ...
      try {
        ...
        setError(errorMessage);
        audioLogger.error('Failed to create audio nodes', { error });
      }
    ...
    const stopAudio = useCallback(() => {
      ...
      try {
        ...
        audioLogger.error('Error stopping audio', { error });
      }
    }, []);
    ...
    if (error) {
      audioLogger.warn('AudioPlayer Error', { error });
    }
