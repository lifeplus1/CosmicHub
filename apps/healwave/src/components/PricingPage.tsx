                ...
                >
                  ...
                  <div className='flex flex-col items-center p-8 space-y-6'>
                    <div className='space-y-2 text-center'>
                      <h3
                        className={`text-xl font-bold ${isPopular ? 'text-purple-600' : 'text-gray-700 dark:text-gray-300'}`}
                      >
                        {tier.name}
                      </h3>
                      ...
                      <div className='flex items-baseline justify-center'>
                        <span
                          className={`text-4xl font-bold ${isPopular ? 'text-purple-600' : 'text-gray-900 dark:text-white'}`}
                        >
                          ${price}
                        </span>
                        {tierSlug !== 'free' && (
